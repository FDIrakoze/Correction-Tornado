...
articles = dict()
url_src = ["https://newsapi.org/v2/top-headlines?sources=google-news-in&apiKey=9e1d0b0198fa42f8b8966332df05b8ed", "https://newsapi.org/v2/top-headlines?sources=google-news-fr&apiKey=9e1d0b0198fa42f8b8966332df05b8ed"]
class MainHandler(tornado.web.RequestHandler): 
    async def get(self) : 
        ...
        self.render("index.html", articles=articles['articles'])

    async def getArticles(self): 
        global url_src
        http_client = tornado.httpclient.AsyncHTTPClient()
        reponses = await multi([http_client.fetch(url) for url in url_src])
